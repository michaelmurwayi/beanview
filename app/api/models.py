...
class Coffee(models.Model):
    ...
    grade = models.CharField(max_length=50, default="", null=True, blank=True)
    ...
    season = models.CharField(max_length=100, default="2024/2025", null=True, blank=True)
    ...
    broker_transport = models.FloatField(null=True, blank=True, default=0.0)
